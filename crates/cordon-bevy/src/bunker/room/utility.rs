...
pub fn spawn(
    ...
    glb(commands, asset_server, "models/interior/KitchenShelves1.glb",
        Vec3::new(l.util_x_min + 0.3, 0.0, l.tj_center - 0.5), Quat::from_rotation_y(FRAC_PI_2));
    ...
    glb(commands, asset_server, "models/interior/Microwave.glb",
        Vec3::new(l.util_x_min + 0.4, 0.9, l.tj_center - 0.5), Quat::from_rotation_y(FRAC_PI_2));
    ...
    glb(commands, asset_server, "models/interior/Mug.glb",
        Vec3::new(l.util_x_min + 0.4, 0.9, l.tj_center + 0.1), Quat::from_rotation_y(FRAC_PI_2));

    // Electric box on the far wall.
    glb(commands, asset_server, "models/storage/ElectricBox_01.glb",
        Vec3::new(l.util_x_min + 0.05, 1.5, l.tj_center - 1.0), Quat::from_rotation_y(FRAC_PI_2));
    // Barrel in the back corner.
    glb(commands, asset_server, "models/storage/Barrel_02.glb",
        Vec3::new(l.util_x_center - 0.5, 0.0, l.back_z + 0.4), Quat::IDENTITY);
}
