...
pub fn spawn(
    ...
    glb(commands, asset_server, "models/storage/Suitcase_01.glb",
        Vec3::new(l.quarters_x_center - 0.3, 0.0, l.back_z + 0.3), Quat::from_rotation_y(0.4));
    // Lamp next to the sofa.
    glb(commands, asset_server, "models/interior/Lamp1.glb",
        Vec3::new(l.quarters_x_max - 0.3, 0.0, l.tj_center - 0.8), Quat::IDENTITY);
    // A bit of life.
    glb(commands, asset_server, "models/interior/PlantPot2.glb",
        Vec3::new(l.hw + 0.4, 0.0, l.back_z + 0.3), Quat::IDENTITY);
    // Second pillow.
    glb(commands, asset_server, "models/interior/Pillow.glb",
        Vec3::new(l.quarters_x_max - 0.5, 0.4, l.tj_center - 0.3), Quat::from_rotation_y(0.5));
}
