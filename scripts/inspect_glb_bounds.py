...
def emit_rust(rows: list[tuple[str, str, list[float], list[float]]]) -> str:
    ...
    lines.append("//")
    lines.append("// DO NOT EDIT BY HAND. This file is produced by scanning every")
    lines.append("// GLB under assets/models/ and reading the real POSITION-buffer")
    lines.append("// min/max accessors. If you add, remove, or modify a model, run:")
    lines.append("//")
    lines.append("//     python3 scripts/inspect_glb_bounds.py --rust")
    lines.append("//")
